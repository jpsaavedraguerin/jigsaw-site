...
<div class="min-h-screen pt-6 font-normal text-xl bg-brown-lightest">
    ...
    <div class="flex py-32 max-w-xl mx-auto justify-around">
        ...
        <div>
            ...
            <h1 class="text-6xl font-bold text-blue-darker leading-0 mb-12">404</h1>
            <h1 class="text-5xl font-bold text-blue-darker mb-6">Página no encontrada</h1>
            <p class="text-grey-dark text-lg mb-6">La página que buscas no pudo ser encontrada</p>

            <a href="/" title="Jigsaw by Tighten" class="bg-purple-dark py-2 px-6 text-sm rounded-lg uppercase text-white shadow">Volver al inicio</a>
        </div>
    </div>
</div>
